		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5chartsfilter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5chartsfilter-display": {
								"semanticObject": "ui5chartsfilter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5chartsfilter",
									"url": sap.ui.require.toUrl("ui5chartsfilter")
								}
							}
						}
					}
